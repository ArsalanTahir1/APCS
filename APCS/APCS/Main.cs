...
return null; 
        ...
        private void btnconvert_Click(object sender, EventArgs e)
        {
           ...
           /*
            using (conn)
            {
                var sql = "SELECT user_num FROM vehicle_own WHERE vehicle_num="+text+"";
        ...
        //    string veh = text;
            ...
            // HERE you SHOULD use a SQL paramter instead of appending strings to build your SQL !!!
             cmd.CommandText = "SELECT v_id FROM vehicle WHERE v_num_plate='" + text + "'";
        ...
        {
            string MyUsername = "923022037116"; //Your Username At Sendpk.com 
            string MyPassword = "1843"; //Your Password At Sendpk.com 
            string toNumber = "923318077234"; //Recepient cell phone number with country code 
            string Masking = "APCS"; //Your Company Brand Name 
            string MessageText = "your vehicle was towed adn you can take your vehicle from IQRA UNIVERSITY STATION";
